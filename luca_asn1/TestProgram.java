...
public class TestProgram {
	...
	public static void main(String[] args) {
		String[] files = new String[] { "./resource/cities1.txt", "./resource/cities2.txt", "./resource/cities3.txt", "./resource/cities4.txt", "./resource/cities5.txt" };
		int[] sizes = new int[] { 21, 15, 10, 15, 36 };
		...
		double[] firsts = new double[] { 36.87817782917155, 551.881327823292, 269.1059270993487, 372.3130403303113,
				512.6646077115134 };
